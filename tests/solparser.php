...
include_once "libs/solparser.php";

$sol = new SolParser('../files/254cde054eea9a8602253ac000998a09.sol');

echo "Public ? " . ($sol->isPublic() ? "true" : "false") . "<br/>";
echo "Message ? " . $sol->getMessage() . "<br/>";
?>
